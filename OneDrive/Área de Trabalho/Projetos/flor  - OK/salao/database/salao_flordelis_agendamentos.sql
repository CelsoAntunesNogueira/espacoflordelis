...
CREATE TABLE `agendamentos` (
  ...
  `status` enum('pendente','confirmado','em_atendimento','concluido','cancelado') COLLATE utf8mb4_unicode_ci DEFAULT 'pendente',
  ...
  CONSTRAINT `agendamentos_ibfk_3` FOREIGN KEY (`profissional_id`) REFERENCES `servicos` (`id`)
